...
function helpMenu() {
    ...
    new_div = document.createElement('div');
    new_div.className = "dos-prompt-container";
    new_div.innerHTML = '<p class="prompt-label">C:></p> <input type="text" id="dosPromptNew" class="dos-prompt-input" autofocus/>';
    document.body.appendChild(new_div);
...
function stockHelpMenu(){
    ...
    new_div = document.createElement('div');
    new_div.className = "dos-prompt-container";
    new_div.innerHTML = '<p class="prompt-label stock-output">C:></p> <input type="text" id="dosPromptNew" class="dos-prompt-input" autofocus/>';
    document.body.appendChild(new_div);
...
function loadStockPrompt(){
    ...
    new_div.innerHTML = '<p class="prompt-label stock-output">$:></p> <input type="text" id="stockPrompt" class="dos-prompt-input" autofocus/>';
    document.body.appendChild(new_div);
...
function newStockPrompt(){
    new_div = document.createElement('div');
    new_div.className = "stock-prompt-container";
    new_div.innerHTML = '<p class="prompt-label stock-output">$:></p> <input type="text" id="stockPromptNew" class="dos-prompt-input" autofocus/>';
    document.body.appendChild(new_div);
}
...
function newLine(output){
    var new_div = document.createElement('div');
    new_div.className = "dos-prompt-container";
    new_div.innerHTML = "<p class='dos-output'>"+ output + "</p>";
    document.body.appendChild(new_div);
}
...
function loadWindows() {
    ...
    var prompt = document.getElementsByClassName('prompt-label');
